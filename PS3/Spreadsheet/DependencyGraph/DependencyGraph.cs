...
namespace Dependencies
{
    ...
    public class DependencyGraph
    {
        ...
        {
            //// if the order match is not on the dependancy graph
            //if (!(dependees.ContainsKey(s) && dependents.ContainsKey(t)))
            //    dg_size++;
            ////if the dependees incldudes 's'
            ...
            //        current.Add(t);
            //        dependees.Add(s, current);
            //    }
            //    //just add 't' to the value HashSet of 's'
            //}
            ...
            //    // add 't' to the HashSet of 's'
            //    dependents.Add(t);
            //    // add 's' and 'dependents' to the dictionary
            //    try
            //    {
            ...
            //    // add 't' to the HashSet of 's'
            //    dependees.Add(s);
            //    // add 't' and 'dependees' to the dictionary
