...
namespace PS4GradingTests
{
    ...
    public class GradingTests
    {
        ...
        public void ThreeArg1()
        {
            ...
            Assert.AreEqual(3.0, f.Evaluate(s => (s == "x") ? 1 : 2));
        }
        ...
        public void ThreeArg6()
        {
            ...
            Assert.AreEqual(1.0, (double)f.Evaluate(s => { throw new UndefinedVariableException(""); }), 1e-6);
        }
        ...
        public void ThreeArg7()
        {
            ...
            Assert.AreEqual(1.0, (double)f.Evaluate(s => (s == "x") ? 1 : 0), 1e-6);
        }
        ...
        public void ThreeArg8()
        {
            ...
            Assert.AreEqual(12.0, (double)f.Evaluate(s => (s == "x") ? 2 : 0), 1e-6);
        }
        ...
        public void ThreeArg9()
        {
            ...
            Assert.AreEqual(10.0, (double)f.Evaluate(s => (s == "X") ? 7 : 3), 1e-6);
        }
        ...
        public void ThreeArg10()
        {
            ...
            Assert.AreEqual(4.0, (double)f.Evaluate(s => (s == "x") ? 1 : 0), 1e-6);
        }
        ...
        public void ToString1()
        {
            ...
            Formula f2 = new Formula(f1.ToString());
            Assert.AreEqual(7.0, (double)f2.Evaluate(s => 0), 1e-6);
        }
        ...
        public void ToString2()
        {
            ...
            Formula f2 = new Formula(f1.ToString());
            Assert.AreEqual(8.0, (double)f2.Evaluate(s => (s == "x") ? 8 : 0), 1e-6);
        }
        ...
        public void ToString4()
        {
            ...
            Formula f2 = new Formula(f1.ToString());
            Assert.AreEqual(24.0, (double)f2.Evaluate(s => char.IsLower(s[0]) ? 16 : 0), 1e-6);
        }
        ...
        public void ToString6()
        {
            ...
            Formula f2 = new Formula(f1.ToString());
            Assert.AreEqual(24.0, (double)f2.Evaluate(s => char.IsUpper(s[0]) ? 16 : 0), 1e-6);
        }
