...
namespace Formulas
{
    ...
    public class GradingTests
    {
        ...
        public void Test21a()
        {
            ...
            Assert.AreEqual(4, (double)f.Evaluate(s => 0), 1e-6);
        }
        ...
        public void Test22()
        {
            ...
            Assert.AreEqual(10, (double)f.Evaluate(s => 10), 1e-6);
        }
        ...
        public void Test23()
        {
            ...
            Assert.AreEqual(9, (double)f.Evaluate(s => 4), 1e-6);
        }
        ...
        public void Test24()
        {
            ...
            Assert.AreEqual(1, (double)f.Evaluate(s => 4), 1e-6);
        }
        ...
        public void Test25()
        {
            ...
            Assert.AreEqual(20, (double)f.Evaluate(s => 4), 1e-6);
        }
        ...
        public void Test26()
        {
            ...
            Assert.AreEqual(2, (double)f.Evaluate(s => 4), 1e-6);
        }
        ...
        public void Test27()
        {
            ...
            Assert.AreEqual(18, (double)f.Evaluate(s => 0), 1e-6);
        }
        ...
        public void Test28()
        {
            ...
            Assert.AreEqual(20, (double)f.Evaluate(s => 0), 1e-6);
        }
        ...
        public void Test29()
        {
            ...
            Assert.AreEqual(40, (double)f.Evaluate(s => 0), 1e-6);
        }
        ...
        {
            Formula f = new Formula("((((((((((((3))))))))))))");
            Assert.AreEqual(3, (double)f.Evaluate(s => 0), 1e-6);
        }
        ...
        public void Test31()
        {
            ...
            Assert.AreEqual(7, (double)f.Evaluate(s => 7), 1e-6);
        }
        ...
        public void Test36()
        {
            ...
            Assert.AreEqual(6, (double)f1.Evaluate(s => 3), 1e-6);
            Assert.AreEqual(0, (double)f2.Evaluate(s => 3), 1e-6);
        }
