...
namespace FormulaTestCases
{
    ...
    public class UnitTests
    {
        ...
        {
            Formula f = new Formula("2+3");
            Assert.AreEqual((double)f.Evaluate(v => 0), 5.0, 1e-6);
        }
        ...
        public void Evaluate2()
        {
            ...
            Assert.AreEqual((double)f.Evaluate(v => 22.5), 22.5, 1e-6);
        }
        ...
        {
            Formula f = new Formula("x + y");
            Assert.AreEqual((double)f.Evaluate(Lookup4), 10.0, 1e-6);
        }
        ...
        public void Evaluate5()
        {
            ...
            Assert.AreEqual((double)f.Evaluate(Lookup4), 20.0, 1e-6);
        }


        [TestMethod()]
        public void punk_tostring1()
        {
            Formula test = new Formula("x2+y3", s => s.ToUpper(), s => true);
            Formula test2 = new Formula("x+y3");
        ...
        /// <summary>
        /// Ensure toString functionality
        /// </summary>
        [TestMethod()]
        public void punk_tostring2()
        {
            Formula test = new Formula("x + y", s => s.ToUpper(), s => true);
            Formula test2 = new Formula("X+Y");
